...
### [claude-cold-outreach-helper](./claude-cold-outreach-helper)
Assists with writing cold outreach and job applications. Uses personal context files (`resume.md`, `non_resume.md`, `additional_context.md`) to generate human-sounding, jargon-free cover letters and emails tailored to specific companies.
...
- [Download claude-cold-outreach-helper](https://download-directory.github.io/?url=https://github.com/nik-55/tools/tree/master/claude-cold-outreach-helper)
